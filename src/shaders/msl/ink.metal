// ink.metal -- Path A port from shader/ink.frag (c82).
// Per-row ink-line effect : white if vertical distance < row brightness.
// Patches :
//   - `texUnit` -> `_aaa_tex_0`
