...
{    
	...
	public: 
		 ...
		 * @return An Error indicating the success or failure of the function.
		 */
		static Error __cdecl	ForceIPAddressToCamera( 
		 ...
		 * @return An Error indicating the success or failure of the function.
		 */
		static Error __cdecl	ForceAllIPAddressesAutomatically();
		 ...
		 * @return An Error indicating the success or failure of the function.
		 */
		static Error __cdecl	ForceAllIPAddressesAutomatically(unsigned int serialNumber);
		 ...
		 */
		static Error __cdecl	DiscoverGigECameras( 
