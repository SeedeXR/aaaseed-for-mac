...
{    
     ...
     */
    //maa	typedef void (*ImageEventCallback)( class Image* pImage, const void* pCallbackData );
	typedef void (__cdecl *ImageEventCallback)( class Image* pImage, const void* pCallbackData );
    /**
