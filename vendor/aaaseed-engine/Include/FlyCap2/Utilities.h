...
namespace FlyCapture2
{
	...
	public:
		 ...
		 */ 
		//maa	static Error GetSystemInfo( 
		static Error __cdecl	GetSystemInfo( 
		 ...
		 * @return An Error indicating the success or failure of the function.
		 */ 
		//maa	static Error GetLibraryVersion(
		static Error __cdecl	GetLibraryVersion(
			FC2Version* pVersion );
		 ...
		 * @return An Error indicating the success or failure of the function.
		 */ 
		//maa	static Error LaunchBrowser( 
		static Error __cdecl	LaunchBrowser(  
			const char*  pAddress );
		 ...
		 * @return An Error indicating the success or failure of the function.
		 */ 
		//maa	static Error LaunchHelp(  
		static Error __cdecl LaunchHelp(  
		 ...
		 * @return An Error indicating the success or failure of the function.
		 */ 
		//maa	static Error LaunchCommand(  
		static Error __cdecl LaunchCommand(  
			const char*  pCommand );
		 ...
		 * @return An Error indicating the success or failure of the function.
		 */ 
		//maa	static Error LaunchCommandAsync(  
		static Error __cdecl LaunchCommandAsync(  
			const char*				pCommand,
