...
#if defined LO_URE_CURRENT_ENV && defined LO_URE_CTOR_ENV_com_dot_sun_dot_star_dot_configuration_dot_ReadOnlyAccess && (LO_URE_CURRENT_ENV) == (LO_URE_CTOR_ENV_com_dot_sun_dot_star_dot_configuration_dot_ReadOnlyAccess) && defined LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_configuration_dot_ReadOnlyAccess
extern "C" ::css::uno::XInterface * SAL_CALL LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_configuration_dot_ReadOnlyAccess(::css::uno::XComponentContext *, ::css::uno::Sequence< ::css::uno::Any > const &);
#endif
...
public:
    static ::css::uno::Reference< ::css::container::XHierarchicalNameAccess > create(::css::uno::Reference< ::css::uno::XComponentContext > const & the_context, const ::rtl::OUString& locale) {
        ...
        try {
#if defined LO_URE_CURRENT_ENV && defined LO_URE_CTOR_ENV_com_dot_sun_dot_star_dot_configuration_dot_ReadOnlyAccess && (LO_URE_CURRENT_ENV) == (LO_URE_CTOR_ENV_com_dot_sun_dot_star_dot_configuration_dot_ReadOnlyAccess) && defined LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_configuration_dot_ReadOnlyAccess
            the_instance = ::css::uno::Reference< ::css::container::XHierarchicalNameAccess >(::css::uno::Reference< ::css::uno::XInterface >(static_cast< ::css::uno::XInterface * >((*LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_configuration_dot_ReadOnlyAccess)(the_context.get(), the_arguments)), ::SAL_NO_ACQUIRE), ::css::uno::UNO_QUERY);
            ::css::uno::Reference< ::css::lang::XInitialization > init(the_instance, ::css::uno::UNO_QUERY);
            if (init.is()) {
                init->initialize(the_arguments);
            }
#else
            the_instance = ::css::uno::Reference< ::css::container::XHierarchicalNameAccess >(the_context->getServiceManager()->createInstanceWithArgumentsAndContext( "com.sun.star.configuration.ReadOnlyAccess", the_arguments, the_context), ::css::uno::UNO_QUERY);
#endif
