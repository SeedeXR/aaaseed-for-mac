...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::frame::XGlobalEventBroadcaster const *) {
    ...
    if ( !the_type )
    {
        ...
        aSuperTypes[2] = ::cppu::UnoType< const ::css::uno::Reference< ::css::document::XEventBroadcaster > >::get().getTypeLibType();
        aSuperTypes[3] = ::cppu::UnoType< const ::css::uno::Reference< ::css::container::XSet > >::get().getTypeLibType();
        aSuperTypes[4] = ::cppu::UnoType< const ::css::uno::Reference< ::css::document::XDocumentEventListener > >::get().getTypeLibType();
        typelib_static_mi_interface_type_init( &the_type, "com.sun.star.frame.XGlobalEventBroadcaster", 5, aSuperTypes );
    }
