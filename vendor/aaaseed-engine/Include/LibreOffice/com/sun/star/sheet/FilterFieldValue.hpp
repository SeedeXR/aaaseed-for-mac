...
inline FilterFieldValue::FilterFieldValue(const ::sal_Bool& IsNumeric_, const double& NumericValue_, const ::rtl::OUString& StringValue_)
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::sheet::FilterFieldValue const *) {
    ...
    if (the_type == 0) {
        ...
        ::typelib_static_struct_type_init(&the_type, "com.sun.star.sheet.FilterFieldValue", 0, 3, the_members, 0);
    }
