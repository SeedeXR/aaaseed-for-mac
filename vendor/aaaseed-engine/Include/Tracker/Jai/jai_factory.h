...
#ifdef __linux__
#	define J_REG_DATABASE_V2_0  "/usr/lib/Registry.xml"						///< Default location of the JAI SDK Registry database file Version 2.0
#	define J_REG_DATABASE  "/usr/lib/Registry.xml"							///< Default location of the JAI SDK Registry database file
#else
#	ifdef _WIN64
#		define J_REG_DATABASE_V2_0  "$(JAI_SDK_DATA)\\Registry_64.xml"		///< Default location of the JAI SDK Registry database file 64-bit Version 2.0 file
#		define J_REG_DATABASE  "$(JAI_SDK_BIN_64)\\Registry.xml"			///< Default location of the JAI SDK Registry database file in 64-bit folder
#	else
#		define J_REG_DATABASE_V2_0  "$(JAI_SDK_DATA)\\Registry_32.xml"		///< Default location of the JAI SDK Registry database file 32-bit Version 2.0 file
#		define J_REG_DATABASE  "$(JAI_SDK_BIN)\\Registry.xml"				///< Default location of the JAI SDK Registry database file in 32-bit folder
#	endif
#endif
...
#define J_GVSP_PIX_COLOR_MASK   0x7F000000

// Indicate effective number of bits occupied by the pixel (including padding).
// This can be used to compute amount of memory required to store an image.
#define J_GVSP_PIX_OCCUPY8BIT	0x00080000
#define J_GVSP_PIX_OCCUPY10BIT	0x000A0000
...
#define J_PFNC_PIX_MONO10_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY10BIT | 0x8004)			// New PFNC
...
#define J_PFNC_PIX_MONO12_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT | 0x8006)			// New PFNC
#define	J_GVSP_PIX_MONO14			(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY16BIT | 0x0025)			// added 2008/07/14 Ver1.1c
...
#define J_GVSP_PIX_BAYGR10_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT  | 0x0026) 
#define J_GVSP_PIX_BAYRG10_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT  | 0x0027) 
#define J_GVSP_PIX_BAYGB10_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT  | 0x0028) 
#define J_GVSP_PIX_BAYBG10_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT  | 0x0029) 
#define J_GVSP_PIX_BAYGR12_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT  | 0x002A) 
#define J_GVSP_PIX_BAYRG12_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT  | 0x002B) 
#define J_GVSP_PIX_BAYGB12_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT  | 0x002C) 
#define J_GVSP_PIX_BAYBG12_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT  | 0x002D) 

// New PFNC types
#define J_PFNC_PIX_BAYGR10_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY10BIT  | 0x8026) 
#define J_PFNC_PIX_BAYRG10_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY10BIT  | 0x8027) 
#define J_PFNC_PIX_BAYGB10_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY10BIT  | 0x8028) 
#define J_PFNC_PIX_BAYBG10_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY10BIT  | 0x8029) 
#define J_PFNC_PIX_BAYGR12_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT  | 0x802A) 
#define J_PFNC_PIX_BAYRG12_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT  | 0x802B) 
#define J_PFNC_PIX_BAYGB12_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT  | 0x802C) 
#define J_PFNC_PIX_BAYBG12_PACKED	(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY12BIT  | 0x802D) 

#define J_GVSP_PIX_BAYGR16			(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY16BIT  | 0x002E) 
#define J_GVSP_PIX_BAYRG16			(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY16BIT  | 0x002F) 
#define J_GVSP_PIX_BAYGB16			(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY16BIT  | 0x0030) 
#define J_GVSP_PIX_BAYBG16			(J_GVSP_PIX_MONO | J_GVSP_PIX_OCCUPY16BIT  | 0x0031) 

// 26.3 RGB Packed buffer format defines
#define J_GVSP_PIX_RGB8_PACKED		(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY24BIT | 0x0014)
#define J_GVSP_PIX_BGR8_PACKED		(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY24BIT | 0x0015)
#define J_GVSP_PIX_RGBA8_PACKED		(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY32BIT | 0x0016)
#define J_GVSP_PIX_BGRA8_PACKED		(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY32BIT | 0x0017)
#define J_GVSP_PIX_RGB10_PACKED		(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY48BIT | 0x0018)
#define J_GVSP_PIX_BGR10_PACKED		(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY48BIT | 0x0019)
#define J_GVSP_PIX_RGB12_PACKED		(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY48BIT | 0x001A)
#define J_GVSP_PIX_BGR12_PACKED		(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY48BIT | 0x001B)
#define J_GVSP_PIX_RGB16_PACKED		(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY48BIT | 0x0033)			// added 2008/07/14 Ver1.1c
#define J_GVSP_PIX_RGB10V1_PACKED	(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY32BIT | 0x001C)
#define J_GVSP_PIX_RGB10V2_PACKED	(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY32BIT | 0x001D)
#define J_GVSP_PIX_RGB12V1_PACKED	(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY36BIT | 0x0034)		// added 2008/07/14 Ver1.1c

// 26.4 YUV Packed buffer format defines
#define J_GVSP_PIX_YUV411_PACKED		(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY12BIT | 0x001E)
#define J_GVSP_PIX_YUV422_PACKED		(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY16BIT | 0x001F)
#define J_GVSP_PIX_YUV422_YUYV_PACKED	(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY16BIT | 0x0032)	// added 2008/07/14 Ver1.1c
#define J_GVSP_PIX_YUV444_PACKED		(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY24BIT | 0x0020)
#define J_GVSP_PIX_YUV420P_NV12_PACKED	(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY12BIT | 0x0040)   // Special YUV 420 semi-planar from TS-5000

// 26.5 RGB Planar buffer format defines
#define J_GVSP_PIX_RGB8_PLANAR		(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY24BIT | 0x0021)
#define J_GVSP_PIX_RGB10_PLANAR		(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY48BIT | 0x0022)
#define J_GVSP_PIX_RGB12_PLANAR		(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY48BIT | 0x0023)
#define J_GVSP_PIX_RGB16_PLANAR		(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY48BIT | 0x0024)
...
// New unified pixel formats for the Vision Library
// These Pixel Formats are used internally in the Vision Library and are unique to the JAI SDK (no longer just GigE Vision)
#define J_PF_MONO8					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_MONO8)
#define J_PF_MONO8_SIGNED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_MONO8_SIGNED)
#define J_PF_MONO10					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_MONO10)
#define J_PF_MONO10_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_MONO10_PACKED)
#define J_PF_MONO10_P				(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_MONO10_PACKED)
#define J_PF_MONO12					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_MONO12)
#define J_PF_MONO12_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_MONO12_PACKED)
#define J_PF_MONO12_P				(J_GVSP_PIX_CUSTOM | J_PFNC_PIX_MONO12_PACKED)
#define	J_PF_MONO14					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_MONO14)
#define J_PF_MONO16					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_MONO16)

#define J_PF_BAYGR8					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYGR8)
#define J_PF_BAYRG8					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYRG8)
#define J_PF_BAYGB8					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYGB8)
#define J_PF_BAYBG8					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYBG8)
#define J_PF_BAYGR10				(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYGR10)
#define J_PF_BAYRG10				(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYRG10)
#define J_PF_BAYGB10				(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYGB10)
#define J_PF_BAYBG10				(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYBG10)
#define J_PF_BAYGR12				(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYGR12)
#define J_PF_BAYRG12				(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYRG12)
#define J_PF_BAYGB12				(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYGB12)
#define J_PF_BAYBG12				(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYBG12)

#define J_PF_BAYGR10_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYGR10_PACKED)
#define J_PF_BAYRG10_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYRG10_PACKED)
#define J_PF_BAYGB10_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYGB10_PACKED)
#define J_PF_BAYBG10_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYBG10_PACKED)
#define J_PF_BAYGR12_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYGR12_PACKED)
#define J_PF_BAYRG12_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYRG12_PACKED)
#define J_PF_BAYGB12_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYGB12_PACKED)
#define J_PF_BAYBG12_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYBG12_PACKED)

#define J_PF_BAYGR10_P				(J_GVSP_PIX_CUSTOM | PFNC_PIX_BAYGR10_PACKED)
#define J_PF_BAYRG10_P				(J_GVSP_PIX_CUSTOM | PFNC_PIX_BAYRG10_PACKED)
#define J_PF_BAYGB10_P				(J_GVSP_PIX_CUSTOM | PFNC_PIX_BAYGB10_PACKED)
#define J_PF_BAYBG10_P				(J_GVSP_PIX_CUSTOM | PFNC_PIX_BAYBG10_PACKED)
#define J_PF_BAYGR12_P				(J_GVSP_PIX_CUSTOM | PFNC_PIX_BAYGR12_PACKED)
#define J_PF_BAYRG12_P				(J_GVSP_PIX_CUSTOM | PFNC_PIX_BAYRG12_PACKED)
#define J_PF_BAYGB12_P				(J_GVSP_PIX_CUSTOM | PFNC_PIX_BAYGB12_PACKED)
#define J_PF_BAYBG12_P				(J_GVSP_PIX_CUSTOM | PFNC_PIX_BAYBG12_PACKED)
#define J_PF_BAYGR16				(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYGR16)
#define J_PF_BAYRG16				(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYRG16)
#define J_PF_BAYGB16				(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYGB16)
#define J_PF_BAYBG16				(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BAYBG16)

#define J_PF_RGB8_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGB8_PACKED)
#define J_PF_BGR8_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BGR8_PACKED)
#define J_PF_RGBA8_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGBA8_PACKED)
#define J_PF_BGRA8_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BGRA8_PACKED)
#define J_PF_RGB10_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGB10_PACKED)
#define J_PF_BGR10_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BGR10_PACKED)
#define J_PF_RGB12_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGB12_PACKED)
#define J_PF_BGR12_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_BGR12_PACKED)
#define J_PF_RGB16_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGB16_PACKED)
#define J_PF_RGB10V1_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGB10V1_PACKED)
#define J_PF_RGB10V2_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGB10V2_PACKED)
#define J_PF_RGB12V1_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGB12V1_PACKED)

#define J_PF_YUV411_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_YUV411_PACKED)
#define J_PF_YUV422_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_YUV422_PACKED)
#define J_PF_YUV422_YUYV_PACKED		(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_YUV422_YUYV_PACKED)
#define J_PF_YUV444_PACKED			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_YUV444_PACKED)
#define J_PF_YUV420P_NV12_PACKED	(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_YUV420P_NV12_PACKED)	// Special YUV 420 semi-planar from TS-5000

#define J_PF_RGB8_PLANAR			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGB8_PLANAR)
#define J_PF_RGB10_PLANAR			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGB10_PLANAR)
#define J_PF_RGB12_PLANAR			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGB12_PLANAR)
#define J_PF_RGB16_PLANAR			(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGB16_PLANAR)

// RGB 8 bit with alpha channel
#define J_GVSP_PIX_RGB8A			(J_GVSP_PIX_COLOR | J_GVSP_PIX_OCCUPY32BIT | 0x0025)

#define J_PF_RGBA8					(J_GVSP_PIX_CUSTOM | J_GVSP_PIX_RGB8A)
...
#define J_BitsPerPixel_INTERNAL(x) (((uint32_t)x & J_GVSP_PIX_EFFECTIVE_PIXEL_SIZE_MASK) >>(uint32_t)J_GVSP_PIX_EFFECTIVE_PIXEL_SIZE_SHIFT)
#define J_BitsPerPixel(x) (MAX_INTERNAL(8, J_BitsPerPixel_INTERNAL(x)))
...
typedef struct _J_tIMAGE_INFO_TYPE 
{
   ...
   uint64_t iBlockId;            ///< GigE Vision Stream Protocol Block-ID
} J_tIMAGE_INFO;
...
/// itself. This handle will be used later on in searching for and accessing the GigE Vision devices. All the Factory specific functions are named 
/// \c J_Factory_...()
/// \code
/// 
...
{
   CAM_INFO_MANUFACTURER	= 1,    //!< Manufacturer name (same as DEVICE_INFO_VENDOR)
   CAM_INFO_MODELNAME		= 2,    //!< Model name (same as DEVICE_INFO_MODEL)
   CAM_INFO_USERNAME		= 6,    //!< User name (same as DEVICE_INFO_USER_DEFINED_NAME)
   CAM_INFO_SERIALNUMBER	= 7,    //!< Serial number (same as DEVICE_INFO_SERIAL_NUMBER)
   CAM_INFO_CMD_CUSTOM		= 1000,
   CAM_INFO_IP				= 1001, //!< IP address
   CAM_INFO_MAC				= 1002, //!< MAC address
   CAM_INFO_INTERFACE_ID	= 1003, //!< Interface name
} J_CAMERA_INFO;
...
} _J_DEVICE_ACCESS_FLAGS_TYPE;
typedef InheritEnum< DEVICE_ACCESS_FLAGS_LIST, _J_DEVICE_ACCESS_FLAGS_TYPE > J_DEVICE_ACCESS_FLAGS_TYPE;
typedef uint32_t J_DEVICE_ACCESS_FLAGS;
...
/// \param [in] indexURL          Index of manifest URL to use, obtained by using \c J_GenTL_GetNumPortURLs() function to find the total number of URLs.
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \note
...
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_Camera_Open(FACTORY_HANDLE hFac, int8_t* pCameraID, CAM_HANDLE* hCam, uint32_t indexURL=0);
...
/// When a cameras has been opened using \c J_Camera_Open() it needs to be closed using \c J_Camera_Close()
/// \sa \c J_Camera_Close(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_Camera_OpenEx(FACTORY_HANDLE hFac, int8_t* pCameraID, CAM_HANDLE* hCam, J_DEVICE_ACCESS_FLAGS iOpenFlags, uint32_t iMcIP, uint32_t indexURL);
...
/// \param [in] sNodeName      Name of the GenICam feature node
/// \retval                    Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \note				       For example, acquisition in the camera is started by calling J_Camera_ExecuteCommand(hCam, "AcquisitionStart") and stopped
///						       using J_Camera_ExecuteCommand(hCam, "AcquisitionStop").
/// The camera needs to be opened using \c J_Camera_Open() before the value can be set
...
/// \ingroup WRAP_CAM
/// @{
/// \brief The following functions are used for accessing the Image Data Streams for a camera.
...
/// starts the acquisition engine inside the driver and create the stream thread connection to the camera using \c J_DataStream_StartAcquisition().
...
{
} _J_ACQ_QUEUE_TYPE_TYPE;
typedef InheritEnum< ACQ_QUEUE_TYPE_LIST, _J_ACQ_QUEUE_TYPE_TYPE > J_ACQ_QUEUE_TYPE;
...
typedef enum  _J_ACQ_START_FLAGS_TYPE
{
   ...
   ACQ_START_LAST_IMAGE  = 0x2,  ///< Deliver the last complete image acquired <br>
                                 ///< This means that between the image delivered last and the image delivered next can be a number of missed images <br>
...
} _J_ACQ_START_FLAGS_TYPE;
typedef InheritEnum< ACQ_START_FLAGS_LIST, _J_ACQ_START_FLAGS_TYPE > J_ACQ_START_FLAGS_TYPE;
typedef uint32_t J_ACQ_START_FLAGS;
...
} _J_ACQ_STOP_FLAGS_TYPE;
typedef InheritEnum< ACQ_STOP_FLAGS_LIST, _J_ACQ_STOP_FLAGS_TYPE > J_ACQ_STOP_FLAGS_TYPE;
typedef uint32_t J_ACQ_STOP_FLAGS;


/// \brief The J_STREAM_INFO_CMD is used to get acquisition information using \c J_DataStream_GetStreamInfo(), \c J_Image_GetStreamInfo()
typedef enum _J_STREAM_INFO_CMD_TYPE
{
   STREAM_INFO_CMD_ID                                   = 0,   
   STREAM_INFO_CMD_NUMBER_OF_FRAMES_DELIVERED           = 1,   ///< This is a uint64_t value. This command inquire the number of acquired frames since the last acquisition start.  
   STREAM_INFO_CMD_NUMBER_OF_FRAMES_LOST_QUEUE_UNDERRUN = 2,   ///< This is a uint64_t value. This command inquire the number of lost frames due to a queue under-run. If the application is not emptying the acquisition queue as fast as the queue gets filled then the newly acquired frames will be dropped and this value will be increased by 1.
   STREAM_INFO_CMD_NUMBER_OF_FARMES_MISSED              = STREAM_INFO_CMD_NUMBER_OF_FRAMES_LOST_QUEUE_UNDERRUN, ///< uint64_t Number of frames missed due to no buffer in the acquisition queue
   STREAM_INFO_CMD_ISGRABBING                           = 8,   ///< This is a bool8_t value. This command inquire if the acquisition engine is running or not. If the value returned is 0 the acquisition engine is currently stopped. 
   STREAM_INFO_CMD_NUMBER_OF_FRAMES_QUEUED = STREAM_INFO_NUM_QUEUED, ///< This is a uint64_t value. This command inquire the number of frame buffers available and ready for image acquisition. When a new frame is acquired then it will be moved from this queue into the delivery queue and this value will be decreased by 1. The application can return the frame buffer to this queue using \c J_DataStream_QueueBuffer() after handling the new image delivery.
   STREAM_INFO_CMD_NUMBER_OF_FRAMES_AWAIT_DELIVERY = STREAM_INFO_NUM_AWAIT_DELIVERY, ///< This is a uint64_t value. This command inquire the number of frames that have been put into the delivery queue and are ready to be read and processed by the application. When the application gets the image using \c J_Event_GetData() then the frame buffer will automatically be removed from this delivery queue and the application then have to manually call \c J_DataStream_QueueBuffer() to return the buffer to the acquisition queue again.
   STREAM_INFO_CMD_CUSTOM_INFO                          = 1000, ///< Every command with an id above this is for custom TLC use
   STREAM_INFO_CMD_NUMBER_OF_FRAMES_CORRUPT_ON_DELIEVRY = 1002,  ///< This is a uint64_t value. This command inquire the number of frames which have been added to the delivery queue despite the fact that they are missing one or more packets. This will only happen if the \c STREAM_PARAM_CMD_PASS_CORRUPT_FRAMES parameter has been set to true using \c J_DataStream_SetStreamParam(). 
} _J_STREAM_INFO_CMD_TYPE;
typedef InheritEnum< STREAM_INFO_CMD_LIST, _J_STREAM_INFO_CMD_TYPE > J_STREAM_INFO_CMD_TYPE;
typedef uint32_t J_STREAM_INFO_CMD;
...
/// \param [in] hDS        Handle to a valid data stream, obtained by \c J_Camera_CreateDataStream() function.
/// \param [in] iFlags     Acquisition start control flag. This parameter is currently not implemented in the GigE Vision drivers so it has currently no effect!!
/// \param [in] iNumImages Number of images to acquire. Use a value of 0 (or ULONG_MAX ==> 0xFFFFFFFFFFFFFFFF) for continuous capture.
/// \retval                Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \note				   Acquisition in the camera is started by calling J_Camera_ExecuteCommand(hCam, "AcquisitionStart") and stopped
///						   using J_Camera_ExecuteCommand(hCam, "AcquisitionStop").
...
/// \sa \c J_Camera_CreateDataStream(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE  __cdecl J_DataStream_StartAcquisition(STREAM_HANDLE hDS, J_ACQ_START_FLAGS iFlags = ACQ_START_FLAGS_NONE, uint64_t iNumImages = ULLONG_MAX);

//******************************************************************************************************************
/// \brief                 Stop the image acquisition on the stream channel
/// \param [in] hDS        Handle to a valid data stream, obtained by \c J_Camera_CreateDataStream() function.
/// \param [in] iFlags     Acquisition stop control flag. This parameter is currently not implemented in the GigE Vision Filter driver but it is necessary to use the ACQ_STOP_FLAGS_KILL if you use the Socket Driver!!
/// \retval                Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \sa \c J_Camera_CreateDataStream(), \c J_STATUS_CODES
...
typedef enum _J_EVENT_INFO_CMD_TYPE
{
	EVENT_INFO_NUM_ENTRYS_IN_QUEUE = EVENT_NUM_IN_QUEUE
} _J_EVENT_INFO_CMD_TYPE;
typedef InheritEnum< EVENT_INFO_CMD_LIST, _J_EVENT_INFO_CMD_TYPE > J_EVENT_INFO_CMD_TYPE;
typedef InheritEnum< EVENT_INFO_CMD_LIST, _J_EVENT_INFO_CMD_TYPE > J_EVENT_INFO_ID;
...
{
   EVENT_GEV_EVENT_CMD = 1001,        ///< GigE Vision Event command received. This is only used with \c J_Camera_RegisterEvent()
   EVENT_GEV_EVENTDATA_CMD = 1002,    ///< Deprecated! Use Event EVENT_GEV_EVENT_CMD instead.
   EVENT_ERROR = 1003,                ///< Error event. This is only used with \c J_Camera_RegisterEvent()
   EVENT_CONNECTION = 1004,           ///< Device Connection Status Change. This is only used with \c J_Camera_RegisterEvent()
   EVENT_MAX_ID
} _J_DEVICE_EVENT_TYPE_TYPE;
typedef InheritEnum< EVENT_TYPE_LIST, _J_DEVICE_EVENT_TYPE_TYPE > J_DEVICE_EVENT_TYPE_TYPE;
typedef uint32_t J_EVENT_TYPE;
...
///
///       error = J_Event_GetInfo(hEvent, (EVENT_INFO_CMD)EVENT_INFO_NUM_ENTRYS_IN_QUEUE, &NumEventsInQueue, &iSize);
///
...
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE  __cdecl J_Event_GetInfo(EVT_HANDLE pEventHandle, J_EVENT_INFO_CMD_TYPE iID, void *pBuffer, uint32_t *pSize);
...
/// \param [in] hEvent         Handle to the event object to be used for signaling the event. This has to be created using the
///                            function \c J_Event_CreateCondition()
...
/// \param [in] hDS            Handle to a valid data stream object, obtained by \c J_Camera_CreateDataStream() function.
/// \param [in] iEventType     Event type to register
/// \param [in] hEvent         Handle to the event object to be used for signaling the event. This has to be created using
///                            function \c J_Event_CreateCondition()
/// \param [out] pEventHandle  Pointer to a variable in which the internal event handle is stored. This handle is used in
///                            \c J_Event_GetData() and \c J_Event_GetInfo()
/// \retval                    Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \code
/// // This small piece of code demonstrate the basics used in the image acquisition thread for
...
///     error = J_Event_GetData(hEvent, &eventData,  &iSize);
///
///		hBuffer = eventData.BufferHandle;
///
///     if (error == J_ST_SUCCESS)
///     {
...
///   switch (iWaitResult)
///   {
///     case J_COND_WAIT_SIGNAL: // The first Condition (GigE Vision Event) got signaled
///       // Get the GigE Vision Event Data from the event
///       iSize = (uint32_t)sizeof(GigEEventData);
...
///         iSize = sizeof(EventInfo);
///
///         error = J_Event_GetInfo(hGevEvent, (EVENT_INFO_CMD)EVENT_INFO_NUM_ENTRYS_IN_QUEUE, &NumEventsInQueue, &iSize);
///
///         if ((error == J_ST_SUCCESS) && (NumEventsInQueue > 0))
///         {
...
///       break;
///
///     case J_COND_WAIT_SIGNAL_1: // The second Condition (Camera Connection Event) got signaled
...
///         iSize = sizeof(EventInfo);
///
///         error = J_Event_GetInfo(hConnectionEvent, (EVENT_INFO_CMD)EVENT_INFO_NUM_ENTRYS_IN_QUEUE, &NumEventsInQueue, &iSize);
///
///         if ((error == J_ST_SUCCESS) && (NumEventsInQueue > 0))
///         {
...
/// are accessible as nodes in a tree-like structure where the top-most level is named "Root". The following code shows how to traverse the
...
/// \endcode
/// \par
/// All the features will have a note type attribute that determines the behavior and functionality of the nodes. The node type can be read
...
/// \ingroup WRAP_IMAGE
/// @{
/// \brief In order to display the acquired images the View Window specific functions need to be used for creating a display window. Many View Windows
...
/// \brief Image View Window Callback type. This type determines how to interpret the data passed in by the callback value parameter. It is also used when the callback mask is set as a View Window option.
...
/// \param [in] iBufferSize   Buffer size to be allocated per image
...
typedef enum
{
	J_PARALLEL_PROCESSING_DEFAULT = -1,	
	J_PARALLEL_PROCESSING_DISABLED = 0,	
	J_PARALLEL_PROCESSING_ENABLED = 1,
} J_PARALLEL_PROCESSING;
 
/// \brief   Allows the user to explicitly enable or disable parallel processing for the J_Image_FromRawToImageEx and J_Image_FromRawtoDIBEx functions.
/// If the function is not called, the behavior is the same as previous versions: passing in one of the J_BAYER_ALGORITHM with "_MULTI" appended
...
/// was also set by the passed in J_BAYER_ALGORITHM parameter to J_Image_FromRawToImageEx and J_Image_FromRAWtoDIBEx.  Now the user can explicitly select the parallel processing mode for all image types
/// (for the J_Image_FromRawToImageEx and J_Image_FromRAWtoDIBEx functions only) by calling J_Image_EnableParallelProcessing.
/// 		
...
/// J_PARALLEL_PROCESSING_ENABLED = 1,
/// \retval none.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_Image_EnableParallelProcessing(J_PARALLEL_PROCESSING processingMode);
...
///           // values you will need to do like this:
...
/// \param [in] saveFlag          Enumeration value that selects the behavior of the Save function. See \c J_SAVE_SETTINGS_FLAG for more information.
/// \retval                 Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \code
...
/// \param [in] hCam              Handle to a valid camera object, obtained by \c J_Camera_Open() function.
/// \param [in] sSettingsFileName Zero terminated string containing the file name for the settings file. The file Name is a 8-bit (ANSI) character string.
/// \param [in] loadFlag          Enumeration value the selects the behavior of the Load function. See \c J_LOAD_SETTINGS_FLAG for more information
/// \retval                 Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \code
...
/// \retval                     Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \note                       The Validation error information string has separated each validation error or warning by
...
/// exposure time and/or gain is different during the two exposures. This is very useful for the 2-CCD monochrome 
...
/// since different network segments can have different latencies. Nevertheless in a switched network, the resulting 
...
/// The color compensation can be applied in up to 10 separate Regions-of-Interests specified in the \c RectOfROI parameter of the \c J_tCOLOR_COMPEN_PARAMS structure.
...
typedef struct _J_tUNDISTORT_PARAMS
{
    ...
    void*  pMapCache;           ///< Internal structure used for speed optimization. Has to be set to 0 before initializing the map using 
} J_tUNDISTORT_PARAMS; 
/// @}

/// \defgroup GENERIC_FACTORY   Generic GenTL functions
/// \brief Support for generic access to devices using a subset of the standard GenTL functions.
/// @{
/// 
/// \defgroup WRAP_TRANSPORTS   Transport layer specific functions
/// @{
//******************************************************************************************************************
/// \brief                        Get the number of GenTL transport layers found after call to \c J_Factory_Open().
/// \param [in] hFac              Handle to a valid factory object, obtained by \c J_Factory_Open() function.
/// \param [out] pNum             Pointer to a variable in which the number of cameras is stored.
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \sa \c J_GenTL_GetNumberOfTransportLayers(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_GenTL_GetNumberOfTransportLayers(FACTORY_HANDLE hFac, int32_t* pNum);

//******************************************************************************************************************
/// \brief                        Get the name of the GenTL transport layer found after call to \c J_GenTL_GetNumberOfTransportLayers().
/// \param [in] hFac              Handle to a valid factory object, obtained by \c J_Factory_Open() function.
/// \param [in] iIndex            The zero-based index of the transport layer, which must be less than the value obtained from \c J_GenTL_GetNumberOfTransportLayers() function.
/// \param [out] phTransport      Pointer to a variable in which a handle of the transport layer object is stored.
/// \param [out] pBuffer          Pointer to a buffer in which the transport layer name is stored.
/// \param [in] iSize			  Specify the size of the buffer. It must be equal or greater then \c J_FACTORY_INFO_SIZE.
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \sa \c J_GenTL_GetNumberOfTransportLayers(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_GenTL_GetTransportLayerByIndex(FACTORY_HANDLE hFac, uint32_t iIndex, TL_HANDLE* phTransport, int8_t* pBuffer, uint32_t iSize);

//******************************************************************************************************************
/// \brief                        Update a list of all interfaces connected to the specified transport layer.
/// \param [in] hTransport        Handle to a valid transport layer object, obtained by \c J_GenTL_GetTransportLayerByIndex()
/// \param [out] bHasChanged      A bool that tells if there is found any new interfaces.
/// \param [in] timeout           Timeout for the update operation. Not currently used.
/// \retval                       Status code defined in the \c J_STATUS_CODES. If the function succeeds, returns \c J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_GenTL_TLUpdateInterfaceList(TL_HANDLE hTransport, bool8_t* bHasChanged, uint64_t timeout);

//******************************************************************************************************************
/// \brief                        Get the number of GenTL interfaces found after call to \c J_GenTL_TLUpdateInterfaceList().
/// \param [in] hTransport        Handle to a valid transport layer object, obtained by \c J_GenTL_GetTransportLayerByIndex()
/// \param [out] pNum             Pointer to a variable in which the number of GenTL interfaces connected to the specified transport layer.
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_GenTL_TLGetNumInterfaces (TL_HANDLE hTransport, uint32_t *pNum);

//******************************************************************************************************************
/// \brief                        Get the name of the GenTL interfaces found after call to \c J_GenTL_TLGetNumInterfaces().
/// \param [in] hTransport        Handle to a valid transport layer object, obtained by \c J_GenTL_GetTransportLayerByIndex()
/// \param [in] iIndex            The zero-based index of the interface, which must be less than the value obtained from \c J_GenTL_TLGetNumInterfaces() function.
/// \param [out] pBuffer          Pointer to a buffer in which the interface layer name is stored.
/// \param [in,out] pSize		  Specify the size of the buffer, and then the function sets an actual size of stored data.
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_GenTL_TLGetInterfaceID (TL_HANDLE hTransport, uint32_t iIndex, int8_t * pBuffer, uint32_t *pSize);

//******************************************************************************************************************
/// \brief                        Get the name of the GenTL interfaces found after call to \c J_GenTL_TLGetNumInterfaces().
/// \param [in] hTransport        Handle to a valid transport layer object, obtained by \c J_GenTL_GetTransportLayerByIndex()
/// \param [in] iInfoCmd          Info command as defined in GenICam::Client::TL_INFO_CMD.
/// \param [out] piType           Datatype of the returned parameter as defined in GenICam::Client::TL_INFO_CMD.
/// \param [out] pBuffer          Pointer to a user allocated buffer to receive the requested information.
/// \param [in,out] piSize		  Specify the size of the buffer, and then the function sets an actual size of stored data.
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_GenTL_TLGetInfo (TL_HANDLE hTransport, TL_INFO_CMD iInfoCmd, INFO_DATATYPE *piType, void *pBuffer, size_t *piSize);

//******************************************************************************************************************
/// \brief                        Open an interface from a interface ID and return valid camera handle.
///                               The ID must be the interface ID returned from the \c J_GenTL_TLGetInterfaceID().
/// \param [in] hTransport        Handle to a valid transport layer object, obtained by \c J_GenTL_GetTransportLayerByIndex()
/// \param [in] pInterfaceName    Interface ID obtained by \c J_GenTL_TLGetInterfaceID() function.
/// \param [out] phIF             Pointer to the variable in which the handle is stored.
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_GenTL_TLOpenInterface (TL_HANDLE hTransport, const int8_t *pInterfaceName,  IF_HANDLE *phIF);
/// @}
/// \defgroup WRAP_INTERFACES   Interface layer specific functions
/// @{

//******************************************************************************************************************
/// \brief                        Update a list of all local devices connected to the specified interface.
/// \param [in] hIF				  Handle to a valid interface layer object, obtained by \c J_GenTL_TLOpenInterface()
/// \param [out] pbChanged        A pointer to a bool that tells if there is found any new devices.
/// \param [in] timeout           Timeout for the update operation. Not currently used.
/// \retval                       Status code defined in the \c J_STATUS_CODES. If the function succeeds, returns \c J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_GenTL_IFUpdateDeviceList(IF_HANDLE hIF, bool8_t *pbChanged, uint64_t timeout);

//******************************************************************************************************************
/// \brief                        Get the number of GenTL local devices found after call to \c J_GenTL_IFUpdateDeviceList().
/// \param [in] hIF				  Handle to a valid interface layer object, obtained by \c J_GenTL_TLOpenInterface()
/// \param [out] pNum             Pointer to a variable in which the number of GenTL local devices connected to the specified transport layer.
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_GenTL_IFGetNumDevices(IF_HANDLE hIF, uint32_t *pNum);

//******************************************************************************************************************
/// \brief                        Get the name of the GenTL local device found after call to \c J_GenTL_IFGetNumDevices().
/// \param [in] hIF				  Handle to a valid interface layer object, obtained by \c J_GenTL_TLOpenInterface()
/// \param [in] iIndex            The zero-based index of the device, which must be less than the value obtained from \c J_GenTL_IFGetNumDevices() function.
/// \param [out] pBuffer          Pointer to a buffer in which the interface layer name is stored.
/// \param [in,out] pSize		  Specify the size of the buffer, and then the function sets an actual size of stored data.
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_GenTL_IFGetDeviceName(IF_HANDLE hIF, uint32_t iIndex, int8_t *pBuffer, uint32_t *pSize);

//******************************************************************************************************************
/// \brief                        Open a local device from a device name and return valid device handle.
///                               The device name must be the ID returned from the \c J_GenTL_IFGetDeviceName().
/// \param [in] hIF				  Handle to a valid interface layer object, obtained by \c J_GenTL_TLOpenInterface()
/// \param [in] pDeviceName       Device name obtained by \c J_GenTL_IFGetDeviceName() function.
/// \param [in] iOpenFlags        Device access Flags
/// \param [out] phDevice             Pointer to the variable in which the handle is stored.
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_GenTL_IFOpenDevice(IF_HANDLE hIF, const int8_t *pDeviceName, DEVICE_ACCESS_FLAGS iOpenFlags, DEV_HANDLE *phDevice);
/// @}
...
/// \param [in] hDevice  		  Handle to a valid local device object, obtained by \c J_GenTL_IFOpenDevice()
/// \param [out] phRemoteDevice   Pointer to the variable in which the handle is stored.
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_GenTL_DevGetPort(DEV_HANDLE hDevice, PORT_HANDLE *phRemoteDevice);

//******************************************************************************************************************
/// \brief                        Queries detailed port information as defined in URL_INFO_CMD.
/// \param [in] hPort  			  Module or remote device port handle to access the Port from.
/// \param [out] indexURL		  Index of manifest URL to use, obtained by using \c J_GenTL_GetNumPortURLs() function to find the total number of URLs.
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_GenTL_GetPortURLInfo(PORT_HANDLE hPort, uint32_t indexURL);

//******************************************************************************************************************
/// \brief                        Inquire the number of available URLs for this port.
/// \param [in] hPort  			  Module or remote device port handle to access the Port from.
/// \param [out] pNumURLs		  Pointer to the variable in which the number of URLs is stored.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_GenTL_GetNumPortURLs(PORT_HANDLE hPort, uint32_t* pNumURLs);

/// @}
/// \defgroup WRAP_GENTL_DATASTREAM   Data stream specific functions
/// @{
...
/// \param [in] iEventType     Event type to register
/// \param [out] pEventHandle  Pointer to a variable in which the internal event handle is stored. This handle is used in
///                            \c J_GenTL_Event_GetData() and \c J_Event_GetInfo()
/// \retval                    Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_GenTL_DataStream_RegisterEvent(STREAM_HANDLE hDS, J_EVENT_TYPE iEventType, EVT_HANDLE *pEventHandle);
...
/// \param [in,out] pSize      The size of the buffer.
///                            The function sets the actual size of data stored into the buffer.
/// \param [in] iTimeout      Timeout for the wait in ms. A value of 0xFFFFFFFFFFFFFFFF is interpreted as INFINITE.
...
/// If the event is of type \c EVENT_GEV_EVENT_CMD then this function will return information about the GEV command as 
/// described by the \c J_EVENT_DATA_GEV_EVENT_CMD structure.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_GenTL_Event_GetData(EVT_HANDLE pEventHandle, void *pBuffer, uint32_t *pSize, uint64_t iTimeout);

/// @}
/// @}

/// \defgroup WRAP_HELPER   Factory helper functions
/// \brief Factory helper functions.
/// @{

//******************************************************************************************************************
/// \brief                        Helper function to convert a specific pixel format value from the remote device to a value understood by the JAI SDK.
/// \param [in] hCam			  Handle to a valid remote device layer object, obtained by \c J_Camera_Open()
/// \param [in] nRemoteFormat	  Pixel format returned by the remote device using \c J_DataStream_GetBufferInfo()
/// \param [in] pJaiPixelFormat	  Pointer to the variable in which the translated pixel format is stored. 
///								  This value may the be used in subsequent SDK calls (for example \c J_Image_ShowImage()).
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_Image_Get_PixelFormat(CAM_HANDLE hCam, uint64_t nRemoteFormat, uint64_t *pJaiPixelFormat);

//******************************************************************************************************************
/// \brief								Helper function to get the current pixel format.
/// \param [in] hCam					Handle to a valid remote device layer object, obtained by \c J_Camera_Open()
/// \param [in] nPixelFormat			Pixel format returned by the remote device using \c J_Image_Get_PixelFormat()
/// \param [out] pJaiPixelFormatName	Pointer to the variable in which the translated pixel format is stored. 
/// \param [in] size					Variable in which the size of the input buffer is stored. 
///										This value may the be used in subsequent SDK calls (for example \c J_Image_ShowImage()).
/// \retval								Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_Image_Get_PixelFormatName(CAM_HANDLE hCam, uint64_t nPixelFormat, int8_t* pJaiPixelFormatName, uint32_t size);

//******************************************************************************************************************
/// \brief                        Helper function to retrieve the GenTL local device layer handle.
/// \param [in] hCam			  Handle to a valid remote device layer object, obtained by \c J_Camera_Open()
/// \param [out] hDevice          Pointer to the variable in which the local device handle is stored.
///								  This value may the be used in subsequent GenICam node calls (for example \c J_Camera_GetNodeByName()).
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_Camera_GetLocalDeviceHandle(CAM_HANDLE hCam, DEV_HANDLE* hDevice);

//******************************************************************************************************************
/// \brief                        Helper function to retrieve the GenTL interface layer handle.
/// \param [in] hCam			  Handle to a valid remote device layer object, obtained by \c J_Camera_Open()
/// \param [out] hInterface       Pointer to the variable in which the interface handle is stored.
///								  This value may the be used in subsequent GenICam node calls (for example \c J_Camera_GetNodeByName()).
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_Camera_GetInterfaceHandle(CAM_HANDLE hCam, IF_HANDLE* hInterface);

//******************************************************************************************************************
/// \brief                        Helper function to retrieve the GenTL transport layer handle.
/// \param [in] hCam			  Handle to a valid remote device layer object, obtained by \c J_Camera_Open()
/// \param [out] hTL			  Pointer to the variable in which the transport handle is stored.
///								  This value may the be used in subsequent GenICam node calls (for example \c J_Camera_GetNodeByName()).
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_Camera_GetTLHandle(CAM_HANDLE hCam, TL_HANDLE* hTL);

//******************************************************************************************************************
/// \brief                        Helper function to determine the transport layer type of handle returned by \c J_Camera_Open().
/// \param [in] hCam			  Handle to a valid camera object, obtained by \c J_Camera_Open() function.
/// \param [out] pBuffer          Pointer to a buffer in which the factory information is stored.
/// \param [in,out] pSize         Specify the size of the buffer. It must be equal or greater then \c J_FACTORY_INFO_SIZE.
/// \retval                       Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_Camera_GetTransportLayerName(CAM_HANDLE hCam, int8_t* pBuffer, uint32_t* pSize);

//Engineering functions - DO NOT USE - THESE MAY BE REMOVED IN THE NEXT UPDATE:
/// \internal
//******* DO NOT USE - THIS MAY BE REMOVED IN THE NEXT UPDATE:********************************************************
/// \brief                 Start the image acquisition on the stream channel
/// \param [in] hThread    Handle to a valid thread object, obtained by \c J_Image_OpenStream() or \c J_Image_OpenStreamLight() function.
/// \param [in] iStartFlags Acquisition start control flag. This parameter is currently not implemented in the GigE Vision drivers so it has currently no effect!!
/// \param [in] iNumToAcquire Number of images to acquire. Use a value of 0 (or ULONG_MAX ==> 0xFFFFFFFFFFFFFFFF) for continuous capture.
/// \retval                Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \note
/// The stream needs to be opened using \c J_Image_OpenStream() or J_Image_OpenStreamLight() before the value can be set
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_Image_DSStartAcquisition(THRD_HANDLE hThread, ACQ_START_FLAGS iStartFlags, uint64_t iNumToAcquire);

//******* DO NOT USE - THIS MAY BE REMOVED IN THE NEXT UPDATE:********************************************************
/// \brief                 Stop the image acquisition on the stream channel
/// \param [in] hThread    Handle to a valid thread object, obtained by \c J_Image_OpenStream() or \c J_Image_OpenStreamLight() function.
/// \param [in] iStopFlags Acquisition stop control flag. This parameter is currently not implemented in the GigE Vision Filter driver but it is necessary to use the ACQ_STOP_FLAGS_KILL if you use the Socket Driver!!
/// \retval                Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// The stream needs to be opened using \c J_Image_OpenStream() or J_Image_OpenStreamLight() before the value can be set
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_Image_DSStopAcquisition(THRD_HANDLE hThread, ACQ_STOP_FLAGS iStopFlags);
...
/// The node type has to be \c IInteger, \c IEnumeration or \c IBoolean
/// \sa \c J_Camera_Open(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_Image_DSGetValueInt64(THRD_HANDLE hThread, int8_t* sNodeName, int64_t *pValue);
...
/// The node type has to be \c IInteger, \c IEnumeration or \c IBoolean
/// \sa \c J_Camera_Open(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_Image_DSSetValueInt64(THRD_HANDLE hThread, int8_t* sNodeName, int64_t Value);
...
/// The node type has to be \c ICommand
/// \sa \c J_Camera_Open(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE __cdecl J_Image_DSExecuteCommand(THRD_HANDLE hThread, int8_t* sNodeName);
/// \endinternal
