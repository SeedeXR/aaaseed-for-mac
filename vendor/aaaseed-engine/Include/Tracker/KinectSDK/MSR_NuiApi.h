...
NUIAPI HRESULT MAAAPIENTRY	MSR_NUIGetDeviceCount( int * pCount ); // note capitalization
NUIAPI HRESULT MAAAPIENTRY	MSR_NuiCreateInstanceByIndex( int Index, INuiInstance ** ppInstance );
NUIAPI void    MAAAPIENTRY	MSR_NuiDestroyInstance( INuiInstance * pInstance );
NUIAPI HRESULT MAAAPIENTRY	MSR_NuiCreateInstanceByName( const OLECHAR *strInstanceName, INuiInstance ** ppNuiInstance );
