...
struct PQMT_CLIENT_API TouchClientRequest{
	...
	char			param[128];	//If type is RQST_TRANSLATOR_CONFIG,it is the name of gesture translator which will be queried from the server configure tools.Otherwise it is reserved.
};

struct PQMT_CLIENT_API TouchDeviceInfo{
	int				screen_width;				//the physical touchable width of touch screen device, in millimeter
	int				screen_height;				//the physical touchable height of touch screen device, in millimeter
...
PQMT_CLIENT_API
void 
(MAACALLBACK *PFuncOnReceivePointFrame)(
...
PQMT_CLIENT_API
void
(MAACALLBACK *PFuncOnReceiveGesture)(
...
PQMT_CLIENT_API
void 
(MAACALLBACK *PFuncOnServerBreak)(
	void * param,
	void * call_back_object
	);
...
PQMT_CLIENT_API
void 
(MAACALLBACK *PFuncOnReceiveError)(
	int		error_code,
	void *	call_back_object
	);
...
PQMT_CLIENT_API
void
(MAACALLBACK *PFuncOnGetServerResolution)(
	int		max_x,
	int		max_y,
	void *	call_back_object
	);
...
PQMT_CLIENT_API
void
(MAACALLBACK *PFuncOnGetDeviceInfo)(
...
PQMT_CLIENT_API
PFuncOnReceivePointFrame	MAAAPIENTRY
SetOnReceivePointFrame(
...
PQMT_CLIENT_API
PFuncOnReceiveGesture	MAAAPIENTRY
SetOnReceiveGesture(
...
PQMT_CLIENT_API
PFuncOnServerBreak	MAAAPIENTRY
SetOnServerBreak(
...
PQMT_CLIENT_API
PFuncOnReceiveError 	MAAAPIENTRY
SetOnReceiveError(
...
PQMT_CLIENT_API
PFuncOnGetDeviceInfo	MAAAPIENTRY
SetOnGetDeviceInfo(
