...
//=============================================================================
//=============================================================================
// $Id: triclops.h,v 2.82 2004/08/09 18:56:50 mwhite Exp $
//=============================================================================
#ifndef TRICLOPS_H
#define TRICLOPS_H
...
#define TRICLOPSLIB_API	   // __declspec( dllimport ) //sr@20101005
...
typedef enum TriclopsImageType
{
   ...
   // the pixel value. 
   TriImg_EDGE,
   // This image type indicates the image is actually multiple images 
   // interleaved. This corresponds to the [B G R U] format that many 
   // RGB framegrabbers deliver data in. 
   TriImg_PACKED
...
typedef enum TriclopsCamera
{
   ...
   // note: TriCam_COLOR is only for use with the Color Triclops.  It is not
   // used for any Digiclops or Bumblebee product
   // TriCam_COLOR may be phased out in future releases of Triclops SDK
   TriCam_COLOR,
...
// 
// Input:
//  e -	The value of a TriclopsError variable.
//
// Returnes:
...
//  TriclopsError
//
TRICLOPSLIB_API char* MAAAPIENTRY
...
//  
//
TRICLOPSLIB_API const char* MAAAPIENTRY
triclopsVersion();
