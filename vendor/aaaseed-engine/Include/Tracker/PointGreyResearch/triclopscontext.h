...
//=============================================================================
//=============================================================================
// $Id: triclopscontext.h,v 2.2 2004/04/26 23:27:56 donm Exp $
//=============================================================================
...
{
   // 3 Camera L-Shaped Triclops or Digiclops.
   TriCfg_L,
...
//=============================================================================
//
//Group = TriclopsContext Manipulation 
...
// 
// Synopsis: 
//  This writes the current calibration file from the TriclopsContext
//  to a file.
//
// Input:
//  context  - The TriclopsContext
...
//
// Description:
//  This function returns the serial number of the Digiclops Stereo Vision 
//  System associated with the given TriclopsContext.
//
// Input:
//  context - The context to extract the serial number from.
// 
// Output:
//  serialNumber - The serial number of the Digiclops Stereo Stereo Vision
//                 System associated with the given context.
//
// Returns:
