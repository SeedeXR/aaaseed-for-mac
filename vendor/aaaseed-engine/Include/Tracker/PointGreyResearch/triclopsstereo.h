...
//=============================================================================
//=============================================================================
// $Id: triclopsstereo.h,v 2.1 2004/04/20 22:05:17 donm Exp $
//=============================================================================
...
//
TRICLOPSLIB_API TriclopsError MAAAPIENTRY
...
//=============================================================================
//
//Group = Widebaseline Stereo

//
// Name: triclopsCreateWidebaselineContext
//
// Synopsis:
//  Creates a widebaseline context based on the contexts of the two underlying
//  stereo devices.
//
// Input:
//  triclops1 - The context for the stereo devive which forms the right camera
//              for the stereo pair.
//  triclops2 - The context for the stereo devive which forms the left camera
//              for the stereo pair.
//
// Output:
...
// Returns:
//  TriclopsErrorOk             - The operation succeeded.
//  InvalidContext - One of the contexts was null
//
// Description:
//  This function creates a widebaseline context based on the contexts of the
//  two underlying stereo devices.  The two input contexts, beside having been
//  properly initialized (and loaded)  must have their transformation set previous 
//  to this operation.  Furthermore, these transforms both relate back to the same 
//  world reference frame so that they can be used to determine how the two cameras
//  are positioned relative to one another.  Once the widebaseline context has been
//  created, stereo processing for the virtual widebaseline camera can proceed by
//  providing it with the corresponding widebaseline input.
//
// Remarks:
...
//
// Name: triclopsCreateWidebaselineInput
//
// Synopsis:
...
//
// Input:
//  input1 - The input from the stereo devive which forms the right camera
//              for the stereo pair.
//  input2 - The input from the stereo devive which forms the left camera
//              for the stereo pair.
//
// Output:
...
// Returns:
//  TriclopsErrorOk             - The operation succeeded.
//  InvalidParameter - One or both inputs is not of type TriInp_RGB (ie.
//                      containing a full stereo image )
//
// Description:
//    Create a widebaseline input based on the TriclopsInput of the two
// underlying stereo devices.  The resulting input can then be used to
// perform stereo processing with the corresponding widebaseline context.
//
// Remarks:
//    This function is scheduled to be DEPRECATED
//
