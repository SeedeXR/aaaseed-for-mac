...
namespace sixenseUtils {
	...
	public:
		...
		static ControllerManager*	MAAAPIENTRY	getTheControllerManager();

		static controller_desc MAAAPIENTRY	controllerDescFromString( sixense_utils_string str );
	...
	// Singleton
	SIXENSE_UTILS_EXPORT ControllerManager*	MAAAPIENTRY	getTheControllerManager();
