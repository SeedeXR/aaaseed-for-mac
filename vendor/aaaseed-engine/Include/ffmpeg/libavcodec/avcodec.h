 ...
 * @param pkt packet
 */
void MAAAPIENTRY	av_init_packet(AVPacket *pkt);
 ...
 */
void MAAAPIENTRY av_free_packet(AVPacket *pkt);
 ...
 */
int MAAAPIENTRY	avpicture_fill(AVPicture *picture, uint8_t *ptr,
 ...
 */
int MAAAPIENTRY	avpicture_get_size(enum PixelFormat pix_fmt, int width, int height);
 ...
 */
AVCodec * MAAAPIENTRY	avcodec_find_decoder(enum CodecID id);
 ...
 */
AVFrame *	MAAAPIENTRY	avcodec_alloc_frame(void);
 ...
 */
attribute_deprecated
int MAAAPIENTRY	avcodec_open(AVCodecContext *avctx, AVCodec *codec);
#endif
 ...
 */
int MAAAPIENTRY	avcodec_decode_video2(AVCodecContext *avctx, AVFrame *picture,
                         int *got_picture_ptr,
 ...
 * do nothing.
 */
int	MAAAPIENTRY	avcodec_close(AVCodecContext *avctx);
