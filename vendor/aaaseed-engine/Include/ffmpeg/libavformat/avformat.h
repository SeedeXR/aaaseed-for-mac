 ...
 */
void MAAAPIENTRY	av_register_all(void);
 ...
 */
AVFormatContext * MAAAPIENTRY avformat_alloc_context(void);
 ...
 */
int MAAAPIENTRY avformat_open_input(AVFormatContext **ps, const char *filename, AVInputFormat *fmt, AVDictionary **options);
 ...
 */
attribute_deprecated
int MAAAPIENTRY av_find_stream_info(AVFormatContext *ic);
#endif
 ...
 *       we do not waste time getting stuff the user does not need.
 */
int MAAAPIENTRY avformat_find_stream_info(AVFormatContext *ic, AVDictionary **options);
 ...
 * @return 0 if OK, AVERROR_xxx on error
 */
int MAAAPIENTRY av_read_packet(AVFormatContext *s, AVPacket *pkt);
 ...
 */
int MAAAPIENTRY	av_read_frame(AVFormatContext *s, AVPacket *pkt);
 ...
 * @return >= 0 on success
 */
int MAAAPIENTRY	av_seek_frame(AVFormatContext *s, int stream_index, int64_t timestamp,
                  int flags);
 ...
 */
int MAAAPIENTRY	avformat_seek_file(AVFormatContext *s, int stream_index, int64_t min_ts, int64_t ts, int64_t max_ts, int flags);

/**
 * Start playing a network-based stream (e.g. RTSP stream) at the
 * current position.
 */
int MAAAPIENTRY	av_read_play(AVFormatContext *s);
 ...
 */
int MAAAPIENTRY	av_read_pause(AVFormatContext *s);
 ...
 */
attribute_deprecated
void MAAAPIENTRY	av_close_input_file(AVFormatContext *s);
#endif
 ...
 * and set *s to NULL.
 */
void MAAAPIENTRY	avformat_close_input(AVFormatContext **s);
/**
 * @}
 */
 ...
 */
int64_t MAAAPIENTRY av_gettime(void);
