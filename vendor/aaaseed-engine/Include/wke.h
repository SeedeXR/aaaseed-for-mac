...
WKE_API void MAACALLBACK wkeInit();
WKE_API void MAACALLBACK wkeShutdown();
WKE_API void MAACALLBACK wkeUpdate();
WKE_API unsigned int MAACALLBACK wkeVersion();
WKE_API const utf8* MAACALLBACK wkeVersionString();
...
WKE_API wkeWebView	MAACALLBACK	wkeCreateWebView();
WKE_API wkeWebView	wkeGetWebView(const char* name);
WKE_API void		MAACALLBACK	wkeDestroyWebView(wkeWebView webView);
