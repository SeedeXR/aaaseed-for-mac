...
XMGLOBALCONST XMVECTORI32 g_XMNegativeZero      = {INT(0x80000000), INT(0x80000000), INT(0x80000000), INT(0x80000000) };
XMGLOBALCONST XMVECTORI32 g_XMNegate3           = {INT(0x80000000), INT(0x80000000), INT(0x80000000), INT(0x00000000) };
XMGLOBALCONST XMVECTORI32 g_XMMask3             = {INT(0xFFFFFFFF), INT(0xFFFFFFFF), INT(0xFFFFFFFF), INT(0x00000000) };
XMGLOBALCONST XMVECTORI32 g_XMMaskX             = {INT(0xFFFFFFFF), INT(0x00000000), INT(0x00000000), INT(0x00000000) };
XMGLOBALCONST XMVECTORI32 g_XMMaskY             = {INT(0x00000000), INT(0xFFFFFFFF), INT(0x00000000), INT(0x00000000) };
XMGLOBALCONST XMVECTORI32 g_XMMaskZ             = {INT(0x00000000), INT(0x00000000), INT(0xFFFFFFFF), INT(0x00000000) };
XMGLOBALCONST XMVECTORI32 g_XMMaskW             = {INT(0x00000000), INT(0x00000000), INT(0x00000000), INT(0xFFFFFFFF) };
...
XMGLOBALCONST XMVECTORI32 g_XMNegOneMask		= { INT(0xFFFFFFFF), INT(0xFFFFFFFF), INT(0xFFFFFFFF), INT(0xFFFFFFFF) };
XMGLOBALCONST XMVECTORI32 g_XMMaskA8R8G8B8      = { INT(0x00FF0000), INT(0x0000FF00), INT(0x000000FF), INT(0xFF000000) };
XMGLOBALCONST XMVECTORI32 g_XMFlipA8R8G8B8      = { INT(0x00000000), INT(0x00000000), INT(0x00000000), INT(0x80000000) };
...
XMGLOBALCONST XMVECTORI32 g_XMMaskA2B10G10R10   = { INT(0x000003FF), INT(0x000FFC00), INT(0x3FF00000), INT(0xC0000000) };
XMGLOBALCONST XMVECTORI32 g_XMFlipA2B10G10R10   = { INT(0x00000200), INT(0x00080000), INT(0x20000000), INT(0x80000000) };
...
XMGLOBALCONST XMVECTORI32 g_XMMaskX16Y16        = { INT(0x0000FFFF), INT(0xFFFF0000), INT(0x00000000), INT(0x00000000) };
...
XMGLOBALCONST XMVECTORI32 g_XMMaskX16Y16Z16W16  = { INT(0x0000FFFF), INT(0x0000FFFF), INT(0xFFFF0000), INT(0xFFFF0000) };
...
XMGLOBALCONST XMVECTORI32 g_XMSelect0101        = { INT(XM_SELECT_0), INT(XM_SELECT_1), INT(XM_SELECT_0), INT(XM_SELECT_1) };
XMGLOBALCONST XMVECTORI32 g_XMSelect1010        = { INT(XM_SELECT_1), INT(XM_SELECT_0), INT(XM_SELECT_1), INT(XM_SELECT_0) };
XMGLOBALCONST XMVECTORI32 g_XMOneHalfMinusEpsilon = { 0x3EFFFFFD, 0x3EFFFFFD, 0x3EFFFFFD, 0x3EFFFFFD};
XMGLOBALCONST XMVECTORI32 g_XMSelect1000        = { INT(XM_SELECT_1), INT(XM_SELECT_0), INT(XM_SELECT_0), INT(XM_SELECT_0) };
XMGLOBALCONST XMVECTORI32 g_XMSelect1100        = { INT(XM_SELECT_1), INT(XM_SELECT_1), INT(XM_SELECT_0), INT(XM_SELECT_0) };
XMGLOBALCONST XMVECTORI32 g_XMSelect1110        = { INT(XM_SELECT_1), INT(XM_SELECT_1), INT(XM_SELECT_1), INT(XM_SELECT_0) };
...
XMGLOBALCONST XMVECTORI32 g_XMFlipY             = {0,INT(0x80000000),0,0};
XMGLOBALCONST XMVECTORI32 g_XMFlipZ             = {0,0,INT(0x80000000),0};
XMGLOBALCONST XMVECTORI32 g_XMFlipW             = {0,0,0,INT(0x80000000)};
XMGLOBALCONST XMVECTORI32 g_XMFlipYZ            = {0,INT(0x80000000),INT(0x80000000),0};
XMGLOBALCONST XMVECTORI32 g_XMFlipZW            = {0,0,INT(0x80000000),INT(0x80000000)};
XMGLOBALCONST XMVECTORI32 g_XMFlipYW            = {0,INT(0x80000000),0,INT(0x80000000)};
...
XMGLOBALCONST XMVECTORI32 g_XMMaskIco4          = {0xFFFFF,INT(0xFFFFF000),0xFFFFF,INT(0xF0000000)};
XMGLOBALCONST XMVECTORI32 g_XMXorXIco4          = {0x80000,0,0x80000,INT(0x80000000)};
...
XMGLOBALCONST XMVECTORI32 g_XMMaskByte4         = {0xFF,0xFF00,0xFF0000,INT(0xFF000000)};
