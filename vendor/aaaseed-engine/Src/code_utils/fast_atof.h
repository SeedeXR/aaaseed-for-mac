...
//
// VENDORED-UNUSED (audited 2026-04-22): this header is in CMakeLists.txt but is
// not #include'd from any .cpp/.h in Src. Kept for potential future use and
// because an external swig-generated binding may reference it (see [16] comment
// on fast_atof_table below). Do not edit this file; if bugs are found, fix a
// copy in project code rather than modifying the vendored source.
...
#ifdef AAA_FAST_ATOF_H
#error "FAST_ATOF_H included more than once."
#endif
#define AAA_FAST_ATOF_H 1
