...
namespace Kinect
{
	...
	FINLINE	REAL	raw_to_cm(	INT32	raw )	{	return REAL( 100.	/	(DOUBLE(raw) * -0.0030711016 + 3.3309495161) );	}
	FINLINE	REAL	raw_to_m(	INT32	raw )	{	return REAL( 1.		/	(DOUBLE(raw) * -0.0030711016 + 3.3309495161) );	}
