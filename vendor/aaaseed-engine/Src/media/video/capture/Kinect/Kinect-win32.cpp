...
namespace Kinect
{
	...
	{
		dll_libusb.usb_init();
		dll_libusb.usb_find_busses();
		dll_libusb.usb_find_devices();

		usb_bus *CurrentBus = dll_libusb.usb_get_busses();
		...
		{
			void* Motor = nullptr;
			if( i<KinectMotorsFound.size() )
				Motor = KinectMotorsFound[i];
	...
	void Kinect::Run_depth()
	{
		mInternalData->RunThread_depth();
	}
	void Kinect::Run_rgb()
	{
		mInternalData->RunThread_rgb();
	}
/*
	void Kinect::Run()
	{
...
*/
	void Kinect::Stop_rgb()
	{
		mInternalData->StopThread_rgb();
	};
	void Kinect::Stop_depth()
	{
		mInternalData->StopThread_depth();
	};
/*
	void Kinect::Stop()
	{
