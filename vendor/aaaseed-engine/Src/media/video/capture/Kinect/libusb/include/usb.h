...
#ifdef AAA_USB_H
#error "USB_H included more than once."
#endif
#define AAA_USB_H 1
...
extern "C"
{
    ...
    /* usb.c */
    usb_dev_handle* USBAPIENTRY	usb_open(struct usb_device *dev);
    ...
    struct usb_device*	USBAPIENTRY	usb_device(usb_dev_handle *dev);
