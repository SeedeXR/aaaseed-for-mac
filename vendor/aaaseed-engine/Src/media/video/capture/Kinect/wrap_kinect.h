#ifdef AAA_WRAP_KINECT_H
#error "WRAP_KINECT_H included more than once."
#endif
#define AAA_WRAP_KINECT_H 1
...
#	endif
#include "Tracker/KinectSDK/NuiApi.h"
#endif
...
#define WRAP_DLL_NAME		"kinect10"
#define WRAP_API_MACRO_H	"wrap_kinect_api_Macro.h"
#define WRAP_CLASS_NAME		c_dll_kinect
#define WRAP_CONV_CALL		__stdcall

#include "lib_wrappers/wrap_class.h"

static	WRAP_CLASS_NAME		dll_kinect;
...
//maa
//	I did it this dirty way because the usual way didn't pass compile
//		the NUIAPI defined as __declspec( dllimport ) could not be used in the .cpp
//		to make it short I hacked it in emergency
