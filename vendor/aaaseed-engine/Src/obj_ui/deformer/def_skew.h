...
#ifdef AAA_DEF_SKEW_H
#error "DEF_SKEW_H included more than once."
#endif
#define AAA_DEF_SKEW_H 1
...
class	c_def_skew final : public c_deformer
{
public:
	FACTORY_DECLARE(c_def_skew,c_deformer);
private:
	REAL	_origin[3];
	INT32	_i_axe;
	INT32	_i_u;
