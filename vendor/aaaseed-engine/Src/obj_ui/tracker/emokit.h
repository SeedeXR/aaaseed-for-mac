...
#ifdef AAA_LIBEMOKIT_H
#error "LIBEMOKIT_H included more than once."
#endif
#define AAA_LIBEMOKIT_H 1
...
#if !AAA_WIN64() && AAA_VSTOOL() < 140
#	define AAA_USE_EMOKIT() 1
#else
#	define AAA_USE_EMOKIT() 0
#endif
