...
DllExport	ISD_TRACKER_HANDLE ISLIB_OpenTracker( HWND hParent, DWORD commPort,
...
DllExport	BOOL  ISLIB_CloseTracker( ISD_TRACKER_HANDLE );
...
DllExport	BOOL  ISLIB_GetTrackerState( ISD_TRACKER_HANDLE, ISD_TRACKER_TYPE *, BOOL verbose );
...
DllExport	BOOL  ISLIB_SetTrackerState( ISD_TRACKER_HANDLE, ISD_TRACKER_TYPE *, BOOL verbose );
...
DllExport	BOOL  ISLIB_GetCommState( ISD_TRACKER_HANDLE, ISD_TRACKER_TYPE * );
...
DllExport	BOOL  ISLIB_SetStationState( ISD_TRACKER_HANDLE, ISD_STATION_CONFIG_TYPE *,
...
DllExport	BOOL  ISLIB_GetStationState( ISD_TRACKER_HANDLE, ISD_STATION_CONFIG_TYPE *,
						WORD stationNum, BOOL verbose );
...
DllExport	BOOL  ISLIB_GetTrackerData( ISD_TRACKER_HANDLE, ISD_DATA_TYPE * );
...
DllExport	BOOL  ISLIB_SendScript( ISD_TRACKER_HANDLE, char * );


/* Number of currently opened trackers is stored in the parameter passed to this
	functions */

DllExport	BOOL  ISLIB_NumOpenTrackers( WORD * );
...
DllExport	HWND  ISLIB_OpenConfigWindow( ISD_TRACKER_HANDLE );
