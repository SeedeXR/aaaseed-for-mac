#ifdef AAA_NUMERICEDIT_H
#error "NUMERICEDIT_H included more than once."
#endif
#define AAA_NUMERICEDIT_H 1


//#include "aaa_type.h"
#ifndef _AFXDLL
#   define _AFXDLL 1    //hack: force MFC as a shared dll
#   include "afxwin.h"  // need from Visual Installer C++ MFC for lastest tools
#endif
...
* 
*   M�a tried in 2025 April to write to gomzygotit@hotmail.com
