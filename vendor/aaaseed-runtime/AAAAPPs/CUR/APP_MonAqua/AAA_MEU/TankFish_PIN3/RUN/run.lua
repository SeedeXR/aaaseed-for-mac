...
-- Scène de plancton bioluminescent => partout

	grea = self:add_grea( "FLASH_KL_A", "B_FLASH", 30, 					1, "KL34" )
		grea:init_box_xyz( 10.5,20, 3.9,8.6, -4.1,-7 )
	grea = self:add_grea( "FLASH_KL_B", "B_FLASH", 40, 					2, "KL34" )
		grea:init_box_xyz( 10.5,20, 0.3,3.8, -4.1,-5  )
	grea = self:add_grea( "FLASH_KC_A", "B_FLASH", 40, 					3, "KC" )
		grea:init_box_xyz( 20.2,23, 3.9,8.6, -4,4 )
