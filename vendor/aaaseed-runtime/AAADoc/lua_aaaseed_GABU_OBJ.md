# AAASeed Lua API -- GABU_OBJ

Generated from `lua_aaaseed_GABU_OBJ.lua`. Do not edit this file directly -- edit the .lua source.

## Table of contents

- [1. CLASS](#1-class)
  - [1.1. DECLARE](#11-declare)
  - [1.2. STATUS](#12-status)
  - [1.3. QUERY](#13-query)
- [2. GABU_OBJ](#2-gabuobj)
  - [2.1. CLASS INTROSPECTION](#21-class-introspection)
  - [2.2. NAME AND LABEL](#22-name-and-label)
    - [2.2.1. NAME](#221-name)
    - [2.2.2. LABEL](#222-label)
  - [2.3. CREATION](#23-creation)
  - [2.4. ACTIVE](#24-active)
  - [2.5. AAASEED](#25-aaaseed)
    - [2.5.1. C_OBJ](#251-cobj)
    - [2.5.2. PARAM](#252-param)
  - [2.6. OUTPUT](#26-output)
    - [2.6.1. PRINT](#261-print)
    - [2.6.2. VERBOSE](#262-verbose)
    - [2.6.3. DIALOG (BOX)](#263-dialog-box)
    - [2.6.4. DUMP](#264-dump)
  - [2.7. UI](#27-ui)
  - [2.8. TREE](#28-tree)
    - [2.8.1. UP](#281-up)
    - [2.8.2. DOWN](#282-down)
    - [2.8.3. APPLY (DOWN)](#283-apply-down)
    - [2.8.4. FIND (DOWN)](#284-find-down)
  - [2.9. DISPATCH](#29-dispatch)
    - [2.9.1. TABLE UTIL](#291-table-util)
    - [2.9.2. FUNCTION / METHOD DISPATCH](#292-function-method-dispatch)
    - [2.9.3. METHOD DISPATCH (ACROSS)](#293-method-dispatch-across)
  - [2.10. INFRASTRUCTURE](#210-infrastructure)
    - [2.10.1. SERIALIZATION](#2101-serialization)
    - [2.10.2. REGISTRY](#2102-registry)
  - [2.11. MISC](#211-misc)
    - [2.11.1. EDIT SOURCE](#2111-edit-source)
    - [2.11.2. MEDIA HELPER](#2112-media-helper)
  - [2.12. Internal DOCumentation (DOC)](#212-internal-documentation-doc)
  - [2.13. UNIT TEST](#213-unit-test)
...
#### 2.9.2. FUNCTION / METHOD DISPATCH
...
### 2.12. Internal DOCumentation (DOC)
