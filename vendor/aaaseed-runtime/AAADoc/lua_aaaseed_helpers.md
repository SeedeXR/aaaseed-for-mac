# AAASeed Lua API -- Helpers

Generated from `lua_aaaseed_helpers.lua`. Do not edit this file directly -- edit the .lua source.

## Table of contents

- [1. MATH](#1-math)
- [2. STRING extensions (lua, defined in aaa_string.lua)](#2-string-extensions-lua-defined-in-aaastringlua)
- [3. TABLE extensions (lua, defined in aaa_table.lua)](#3-table-extensions-lua-defined-in-aaatablelua)
- [4. ARRAY](#4-array)
- [5. FORMAT](#5-format)
- [6. V2 (vector_2d.lua)](#6-v2-vector2dlua)
  - [6.1. BASE](#61-base)
  - [6.2. OPERATION](#62-operation)
  - [6.3. BARYCENTER](#63-barycenter)
  - [6.4. SPECIAL (operate on tables of V2 points)](#64-special-operate-on-tables-of-v2-points)
  - [6.5. TRANSFO](#65-transfo)
  - [6.6. NORMAL TANGENT](#66-normal-tangent)
  - [6.7. NORM DIST](#67-norm-dist)
  - [6.8. INTERPOLATE](#68-interpolate)
  - [6.9. ANGLE / DOT](#69-angle-dot)
- [7. V3 (vector_3d.lua)](#7-v3-vector3dlua)
  - [7.1. BASE](#71-base)
  - [7.2. OPERATION](#72-operation)
  - [7.3. BARYCENTER](#73-barycenter)
  - [7.4. TRANSFO](#74-transfo)
  - [7.5. NORM DIST](#75-norm-dist)
  - [7.6. INTERPOLATE](#76-interpolate)
  - [7.7. ANGLE](#77-angle)
  - [7.8. CROSS / DOT](#78-cross-dot)
  - [7.9. SPEED / COMBINE / SLERP](#79-speed-combine-slerp)
- [8. RECT (RECT.lua)](#8-rect-rectlua)
  - [8.1. LBRT (axis-aligned)](#81-lbrt-axis-aligned)
  - [8.2. RECT (oriented, with rotation)](#82-rect-oriented-with-rotation)
- [9. CSV / SPLIT (csv_util.lua)](#9-csv-split-csvutillua)
...
## 2. STRING extensions (lua, defined in aaa_string.lua)
...
## 3. TABLE extensions (lua, defined in aaa_table.lua)
...
### 6.4. SPECIAL (operate on tables of V2 points)
...
### 8.2. RECT (oriented, with rotation)
...
## 9. CSV / SPLIT (csv_util.lua)

```lua
	tab	= fromCSV( str, del )						-- lua	parse a CSV-style string with delimiter del; supports quoted fields with "" escapes
