# AAASeed Lua API -- Interface

Generated from `lua_aaaseed_interface.lua`. Do not edit this file directly -- edit the .lua source.

## Table of contents

- [1. CORE / BOOTSTRAP](#1-core-bootstrap)
  - [1.1. TIME](#11-time)
  - [1.2. HOOK](#12-hook)
  - [1.3. Window title](#13-window-title)
  - [1.4. AAASeed Variables](#14-aaaseed-variables)
  - [1.5. SCRIPT and LUA](#15-script-and-lua)
  - [1.6. INFO](#16-info)
  - [1.7. JIT](#17-jit)
- [2. AAAseed OBJECT (c_obj)](#2-aaaseed-object-cobj)
- [3. PARAM](#3-param)
- [4. AAA UTIL (lua, defined in aaa_util.lua)](#4-aaa-util-lua-defined-in-aaautillua)
- [5. DATAGRID](#5-datagrid)
- [6. UI](#6-ui)
  - [6.1. KEYBOARD (lua, defined in aaa_keyboard.lua)](#61-keyboard-lua-defined-in-aaakeyboardlua)
  - [6.2. MOUSE](#62-mouse)
  - [6.3. EVENT](#63-event)
  - [6.4. ACTION](#64-action)
  - [6.5. WINDOW (lua)](#65-window-lua)
  - [6.6. SCREEN (lua)](#66-screen-lua)
  - [6.7. FLATLAND](#67-flatland)
  - [6.8. MENU](#68-menu)
- [7. INPUT / OUTPUT](#7-input-output)
  - [7.1. MIDI](#71-midi)
  - [7.2. MESSAGE](#72-message)
  - [7.3. DIALOG](#73-dialog)
  - [7.4. CLIPBOARD](#74-clipboard)
- [8. MEDIA](#8-media)
  - [8.1. AUDIO](#81-audio)
  - [8.2. VIDEO](#82-video)
- [9. INFRASTRUCTURE](#9-infrastructure)
  - [9.1. MATERIAL](#91-material)
  - [9.2. MODULES](#92-modules)
  - [9.3. MODULE](#93-module)
  - [9.4. LAYERS](#94-layers)
  - [9.5. LAYER](#95-layer)
  - [9.6. CAMERA](#96-camera)
  - [9.7. VIEWPORT (lua)](#97-viewport-lua)
  - [9.8. FBO](#98-fbo)
  - [9.9. SHADING](#99-shading)
  - [9.10. STEREO (lua)](#910-stereo-lua)
  - [9.11. LIGHTS](#911-lights)
  - [9.12. DEFORMER](#912-deformer)
  - [9.13. MULTIPLE](#913-multiple)
- [10. BDD](#10-bdd)
  - [10.1. GENERIC](#101-generic)
  - [10.2. BDD POINT (implemented bdd by bdd, error message when not implemented)](#102-bdd-point-implemented-bdd-by-bdd-error-message-when-not-implemented)
  - [10.3. BDD BOID](#103-bdd-boid)
  - [10.4. BDD_VOXEL](#104-bddvoxel)
  - [10.5. BDD_PART](#105-bddpart)
  - [10.6. BDD_GRID_ADJUSTABLE](#106-bddgridadjustable)
  - [10.7. BDD_BOXES only for now](#107-bddboxes-only-for-now)
  - [10.8. BDD bdd_tube_path](#108-bdd-bddtubepath)
  - [10.9. BDD_TUBE_PATH](#109-bddtubepath)
  - [10.10. BDD_CURVE_3D, BDD_LINE_3d, BDD_MOCAP](#1010-bddcurve3d-bddline3d-bddmocap)
  - [10.11. BDD_CURVE_3D and BDD_MOCAP only](#1011-bddcurve3d-and-bddmocap-only)
  - [10.12. BDD_CURVE_3D and BDD_LINE_3d only](#1012-bddcurve3d-and-bddline3d-only)
  - [10.13. BDD_LINE_3D only (quite specialized to transfert boid to curve in script for aquariuns](#1013-bddline3d-only-quite-specialized-to-transfert-boid-to-curve-in-script-for-aquariuns)
  - [10.14. BDD_CURVE_EDIT](#1014-bddcurveedit)
  - [10.15. BDD_IMG_CONTOUR and BDD_BLOB BDD_BLOB_TRACKING (derived fron bdd_blob_base)](#1015-bddimgcontour-and-bddblob-bddblobtracking-derived-fron-bddblobbase)
  - [10.16. BDD_BLOB](#1016-bddblob)
  - [10.17. BDD_BLOB_TRACKING](#1017-bddblobtracking)
  - [10.18. BDD_FIELD_GENE only](#1018-bddfieldgene-only)
  - [10.19. DEF_WALL_INTERACTION](#1019-defwallinteraction)
  - [10.20. BDD_FLEX only](#1020-bddflex-only)
  - [10.21. BDD_BULLET only](#1021-bddbullet-only)
  - [10.22. BDD dataset bdd_opencl_part](#1022-bdd-dataset-bddopenclpart)
- [11. NETWORK](#11-network)
  - [11.1. NET](#111-net)
  - [11.2. NET REQUESTS (HTTP)](#112-net-requests-http)
  - [11.3. OSC](#113-osc)
- [12. FILES](#12-files)
  - [12.1. FILE AND DIR](#121-file-and-dir)
  - [12.2. FILE DIALOG](#122-file-dialog)
- [13. SYSTEM / DIAGNOSTICS](#13-system-diagnostics)
  - [13.1. PC](#131-pc)
  - [13.2. POWER (lua, defined in aaa_power.lua)](#132-power-lua-defined-in-aaapowerlua)
  - [13.3. SPY	implement NSight for now](#133-spyimplement-nsight-for-now)
  - [13.4. DEBUG (lua, defined in aaa_debug.lua)](#134-debug-lua-defined-in-aaadebuglua)
  - [13.5. WATCHDOG](#135-watchdog)
...
## 4. AAA UTIL (lua, defined in aaa_util.lua)
...
### 6.1. KEYBOARD (lua, defined in aaa_keyboard.lua)
...
### 10.2. BDD POINT (implemented bdd by bdd, error message when not implemented)
...
### 10.10. BDD_CURVE_3D, BDD_LINE_3d, BDD_MOCAP
...
### 10.11. BDD_CURVE_3D and BDD_MOCAP only

```lua
	x,y,z				=	aaa.bdd.coor_to_world			(	BDD,	node_id, x,y,z	)
```

### 10.12. BDD_CURVE_3D and BDD_LINE_3d only
...
### 10.13. BDD_LINE_3D only (quite specialized to transfert boid to curve in script for aquariuns

```lua
	len = aaa.bdd.push_control_point_back_len_max( BDD, dataset_id, x,y,z, len_max ))
```

### 10.14. BDD_CURVE_EDIT

```lua
	val = aaa.bdd.get_curve_val( BDD, control_id, phase )
```

### 10.15. BDD_IMG_CONTOUR and BDD_BLOB BDD_BLOB_TRACKING (derived fron bdd_blob_base)
...
### 10.17. BDD_BLOB_TRACKING

```lua
	b	= aaa.bdd.get_ghost(	BDD, index )
```

### 10.18. BDD_FIELD_GENE only
...
### 10.22. BDD dataset bdd_opencl_part
...
### 13.2. POWER (lua, defined in aaa_power.lua)
...
### 13.3. SPY	implement NSight for now
...
### 13.4. DEBUG (lua, defined in aaa_debug.lua)
