...
CONST float pixel_dist		= aaa_vu_float[0];
...
CONST vec3  push_xyz		= aaa_vu_vec4[1].xyz;
//CONST float push_factor	= aaa_vu_vec4[1].w;
CONST float normal_factor	= aaa_vu_vec4[1].w;

CONST vec3 duv = aaa_vu_vec4[0].xyz * pixel_dist;	// z is zero
