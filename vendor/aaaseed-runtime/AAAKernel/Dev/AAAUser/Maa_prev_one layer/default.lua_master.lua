...
--todo manage to have it functionning
if false then
	...
	table.print( socket, "Socket Before", 2 )
	doit( path.."socket" )
	table.print( socket, "Socket After", 2 )
	doit( path.."url" )
	table.print( socket, "Url After", 2 )
	doit( path.."ltn12" )
	table.print( socket, "ltn12 After", 2 )
	doit( path.."headers" )
	table.print( socket, "headers After", 2 )
	doit( path.."http" )
	table.print( socket, "http After", 2 )
--	doit( path.."ssl" )	--todo probably need to be trashed or called vis required
--	table.print( ssl, "ssl After", 2 )
end
